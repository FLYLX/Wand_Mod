...
public class StoneScroll extends Item implements  IAnimatable, ISyncable {

    public static final String controllerName = "controller5";
    public static final int ANIM_OPEN = 0;
    public AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public long now_time,remain_time;

    public StoneScroll(Settings settings) {
        super(settings);
    ...
    public void inventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean selected) {
        ...
        if (!world.isClient()) {
            ...
            if (entity instanceof PlayerEntity) {
                if (((PlayerEntity) entity).getOffHandStack().isOf(modItemRegistry.STONE_SCROLL) &&
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient()) {
            if(user.getOffHandStack().isOf(modItemRegistry.STONE_SCROLL)) {
