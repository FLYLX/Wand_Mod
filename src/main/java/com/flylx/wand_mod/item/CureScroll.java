...
public class CureScroll extends Item implements  IAnimatable, ISyncable {

    public static final String controllerName = "cure_controller";
    public static final int ANIM_OPEN = 0;
    public AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public long now_time,remain_time;

    public CureScroll(Settings settings) {
        super(settings);
    ...
    public void inventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean selected) {
        ...
        if (!world.isClient()) {
            ...
            if (entity instanceof PlayerEntity) {
                    if (((PlayerEntity) entity).getOffHandStack().isOf(modItemRegistry.CURE_SCROLL) &&
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient()) {
            if(user.getOffHandStack().isOf(modItemRegistry.CURE_SCROLL)) {
